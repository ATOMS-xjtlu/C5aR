...
#  I=$((I+1))
#done
pmemd.cuda -O -i 7_production.mdin -p input.parm7 -c production2.rst -o production3.out -x production3.trj -r production3.rst -ref production2.rst
