...
#SBATCH -J apo_second_2         # Job name
...
#  I=$((I+1))
#done
pmemd.cuda -O -i ../7_production.mdin -p ../input.parm7 -c production_second.rst -o production_second_2.out -x production_second_2.trj -r production_second_2.rst -ref production_second.rst
