...
#  I=$((I+1))
#done
pmemd.cuda -O -i ../7_production.mdin -p ../input.parm7 -c ../6_equilibration.rst -o production_second.out -x production_second.trj -r production_second.rst -ref ../6_equilibration.rst
