...
#  I=$((I+1))
#done
pmemd.cuda -O -i ../7_production.mdin -p ../input.parm7 -c production_third_2.rst -o production_third_3.out -x production_third_3.trj -r production_third_3.rst -ref production_third_2.rst
