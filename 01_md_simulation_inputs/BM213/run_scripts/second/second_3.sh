...
#SBATCH -J bm213_second_3        # Job name
...
#  I=$((I+1))
#done
pmemd.cuda -O -i ../7_production.mdin -p ../input.parm7 -c production_2.rst -o production_3.out -x production_3.trj -r production_3.rst -ref production_2.rst
