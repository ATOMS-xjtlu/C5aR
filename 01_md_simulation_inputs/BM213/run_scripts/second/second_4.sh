...
#SBATCH -J bm213_second_4        # Job name
...
#  I=$((I+1))
#done
pmemd.cuda -O -i ../7_production.mdin -p ../input.parm7 -c production_3.rst -o production_4.out -x production_4.trj -r production_4.rst -ref production_3.rst
