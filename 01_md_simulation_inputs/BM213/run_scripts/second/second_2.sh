...
#SBATCH -J bm213_second_2        # Job name
...
#  I=$((I+1))
#done
pmemd.cuda -O -i ../7_production.mdin -p ../input.parm7 -c production_1.rst -o production_2.out -x production_2.trj -r production_2.rst -ref production_1.rst
