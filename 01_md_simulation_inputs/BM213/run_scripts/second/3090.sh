...
#SBATCH -J bm213_second_1        # Job name
...
#  I=$((I+1))
#done
pmemd.cuda -O -i ../7_production.mdin -p ../input.parm7 -c ../6_equilibration.rst -o production_1.out -x production_1.trj -r production_1.rst -ref ../6_equilibration.rst
