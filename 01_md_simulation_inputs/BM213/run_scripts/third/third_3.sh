...
#SBATCH -J bm213_third_4        # Job name
...
#  I=$((I+1))
#done
pmemd.cuda -O -i ../7_production.mdin -p ../input.parm7 -c production_third_3.rst -o production_third_4.out -x production_third_4.trj -r production_third_4.rst -ref production_third_3.rst
