...
#SBATCH -J bm213_third_1        # Job name
...
#  I=$((I+1))
#done
pmemd.cuda -O -i ../7_production.mdin -p ../input.parm7 -c ../6_equilibration.rst -o production_third_1.out -x production_third_1.trj -r production_third_1.rst -ref ../6_equilibration.rst
