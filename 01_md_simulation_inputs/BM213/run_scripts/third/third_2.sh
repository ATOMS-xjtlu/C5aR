...
#SBATCH -J bm213_third_2        # Job name
...
#  I=$((I+1))
#done
pmemd.cuda -O -i ../7_production.mdin -p ../input.parm7 -c production_third_1.rst -o production_third_2.out -x production_third_2.trj -r production_third_2.rst -ref production_third_1.rst
