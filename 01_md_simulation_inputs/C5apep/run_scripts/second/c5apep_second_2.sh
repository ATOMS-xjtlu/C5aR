...
#SBATCH -J c5apep_second_2        # Job name
...
#  I=$((I+1))
#done
pmemd.cuda -O -i ../7_production.mdin -p ../input.parm7 -c production.rst -o production_second_2.out -x production_second_2.trj -r production_second_2.rst -ref production.rst
