...
#SBATCH -J c5apep_second_3         # Job name
...
#  I=$((I+1))
#done
pmemd.cuda -O -i ../7_production.mdin -p ../input.parm7 -c production_second_2.rst -o production_second_3.out -x production_second_3.trj -r production_second_3.rst -ref production_second_2.rst
