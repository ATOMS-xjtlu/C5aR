...
#SBATCH -J c5apep_second_4         # Job name
...
#  I=$((I+1))
#done
pmemd.cuda -O -i ../7_production.mdin -p ../input.parm7 -c production_second_3.rst -o production_second_4.out -x production_second_4.trj -r production_second_4.rst -ref production_second_3.rst
