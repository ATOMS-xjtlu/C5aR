...
#  I=$((I+1))
#done
pmemd.cuda -O -i 7_production.mdin -p input.parm7 -c production1.rst -o production2.out -x production2.trj -r production2.rst -ref production1.rst
