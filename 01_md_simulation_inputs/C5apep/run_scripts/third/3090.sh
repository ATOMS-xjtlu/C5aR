...
#SBATCH -J c5apep_third_6        # Job name
...
#  I=$((I+1))
#done
pmemd.cuda -O -i ../7_production.mdin -p ../input.parm7 -c production_third_5.rst -o production_third_6.out -x production_third_6.trj -r production_third_6.rst -ref production_third_5.rst
